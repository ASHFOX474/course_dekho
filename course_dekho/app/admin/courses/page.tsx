...
export default function AdminCoursesPage() {
  ...
  return <AppShell title="Academic management" allowedRoles={['admin']}>
    <div className="space-y-5">
      <div><p className="page-kicker mb-2">Academic structure</p><h2 className="page-title">Manage the learning roadmap</h2><p className="mt-2 text-sm text-slate-500">Build universities, semesters, courses, and ordered topics. Add learning resources when you are ready.</p></div>
