...
const learnerPermissions: readonly Permission[] = [
  "browse_approved_content",
  "bookmark_content",
  "track_progress",
  "solve_question",
...
export function createPendingSubmission(
  ...
  const contributor = requireRole(actor, "contributor");
...
export function approvePendingSubmission(
  ...
  return {
    ...
    resource: {
      ...
      addedById: submission.contributorId,
      addedByName: submission.contributorName,
