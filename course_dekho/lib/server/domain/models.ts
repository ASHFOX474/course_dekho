export const userRoles = ["learner", "contributor", "admin"] as const;
...
// A learner or contributor account awaiting admin review. Admins never appear
// here — they are never created through public self-registration.
...
// Every account regardless of role or review state -- the admin "how many
// people are using this" directory. isActive distinguishes a working account
// from one an admin deactivated; deactivated accounts are never hard-deleted.
