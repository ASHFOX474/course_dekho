...
// One row per learner/contributor account awaiting admin review.
export interface PendingUserRow extends QueryResultRow {
  user_public_id: string;
  user_name: string;
  user_email: string;
  user_username: string;
...
// One row per account in the admin's full user directory (any role, any
// review state) -- distinct from PendingUserRow, which only covers the
// pending-review queue.
export interface DirectoryUserRow extends QueryResultRow {
  user_public_id: string;
  user_name: string;
  user_email: string;
  user_username: string;
